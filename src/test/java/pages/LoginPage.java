...
public class LoginPage {
    ...
    public void Login(String email, String pass)
    {
        try{
            ...
            driver.findElement(By.cssSelector("a[data-qa-id= 'layout-header-user-logon']")).click();
            logger.info("Giriş yap bağlantısına tıklandı.");
            driver.findElement(By.cssSelector(("button[data-qa-id = 'oauth-logon-button']"))).click();
            ...
            driver.findElement(By.cssSelector(("input[data-qa-input-qualifier = 'password']"))).sendKeys(pass);
